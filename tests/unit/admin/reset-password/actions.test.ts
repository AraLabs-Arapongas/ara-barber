...
import { resetPasswordAction, type ResetPasswordState } from '@/app/admin/reset-password/actions'
...
describe('resetPasswordAction', () => {
  ...
  it('chama updateUser e redireciona pra /admin/dashboard em caso de sucesso', async () => {
